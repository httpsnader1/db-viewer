    ...
    <div class="flex flex-wrap items-center gap-3">
      ...
      <div class="relative flex-1 min-w-48">
        ...
        <input
          ...
          class="w-full pl-9 pr-3 py-2 bg-gray-800 border border-gray-700 rounded-lg text-sm text-white placeholder-gray-500 focus:outline-none focus:border-violet-500 transition-colors"
        />
        <button
          v-if="localSearch"
          @click="localSearch = ''"
          ...
          <thead>
            <tr class="border-b border-gray-800 bg-gray-900/90 backdrop-blur-md sticky top-0 z-10">
              <th
                ...
                :key="col.name"
                class="px-4 py-3.5 text-left text-xs font-bold text-gray-400 uppercase tracking-widest whitespace-nowrap select-none"
              >
                <button
          ...
          <tbody class="divide-y divide-gray-800/60">
            ...
            >
              <td
                v-for="col in visibleColumns"
                :key="col.name"
                class="px-4 py-3.5 text-gray-300 border-r border-gray-800/30 last:border-r-0"
              >
